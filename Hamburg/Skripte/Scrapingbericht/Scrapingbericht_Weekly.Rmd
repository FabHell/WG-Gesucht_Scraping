...
## Performance der Scrapingloops

Von den Scrapingzyklen diese Woche mit neuen Links waren ...

-   ... [**`r sum(str_detect(all_logs$Ergebnis, "^Erfolgreich \\d+ Links$"))`**]{style="color: green;"} der Loops vollständig erfolgreich, [**`r sum(str_detect(all_logs$Ergebnis, "^TW Erfolgreich \\d+/\\d+$"))`**]{style="color: orange;"} teilweise erfolgreich und bei [**`r sum(all_logs$Ergebnis == "Kein Scraping")`**]{style="color: red;"} der Loops keine<br>Datenabfragen möglich.
-   Noch eine Aussage zu dem **[braunen Histogram]{style="color: #a0896f;"}**
...
Abb_1 <- all_logs %>%
  ...
  geom_col(fill = "#a0896f", color = "#ffffff") +
...
Abb_1 + Abb_2  +
  plot_layout(ncol = 1, heights = c(0.4, 1))
