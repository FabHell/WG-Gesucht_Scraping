...
```{r plot, include=TRUE, fig.height=2.5, fig.width=7}
...
## Report Scrapingloops

Von den heutigen Scrapingzyklen mit neuen Links waren ...

-   [**`r sum(str_detect(scraping_logs$Ergebnis, "^Erfolgreich \\d+ Links$"))`**]{style="color: green;"} der Scrapingloops vollständig erfolgreich.
...
kable(scraping_matrix, escape = FALSE, format = "html",
  ...
  column_spec(1, width = "100px", extra_css = "border-right: 2px solid #000; padding-left: 8px;
              background-color: #f8f5f2; font-size: 13px;") %>% 
  column_spec(2:6, width = "100px",
              extra_css = "background-color: #f8f5f2; font-size: 13px;") %>% 
  row_spec(1, extra_css = "border-top: 2px solid #000; padding-left: 8px; line-height: 1.5;") %>% 
  row_spec(2:nrow(scraping_matrix),
           extra_css = "border-top: 2px solid #f8f5f2; padding-left: 8px; line-height: 1.5;") %>%
