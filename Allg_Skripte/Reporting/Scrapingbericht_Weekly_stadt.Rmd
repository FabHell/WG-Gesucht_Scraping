...
-  Die Lage der Wohnung wurde für [**`r round(((nrow(Daten_ges %>% filter(datum_scraping > Sys.Date()-7 & stadtteil_quelle == "Geocode_OSM")) / nrow(Daten_ges))*100),1)`%**]{style="color: #8d75aa;"} der Angebote mittels Geocoding ermittelt.
